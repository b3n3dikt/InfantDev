...
do
  ...
  wb_command -show-scene  -use-window-size ${scene_files}/Anat_QC_outputs_v2.scene 1 ${imageout}/${sub}_${sesh}_surfaces_wHead_QC.png 1000 800
  wb_command -show-scene  -use-window-size ${scene_files}/Anat_QC_outputs_v2.scene 2 ${imageout}/${sub}_${sesh}_surfaces_wBrain_QC.png 1000 800
  wb_command -show-scene  -use-window-size ${scene_files}/Anat_QC_outputs_v2.scene 3 ${imageout}/${sub}_${sesh}_aseg_acpc_QC.png 1000 800
  wb_command -show-scene  -use-window-size ${scene_files}/Anat_QC_outputs_v2.scene 4 ${imageout}/${sub}_${sesh}_aseg_acpc_transparent_QC.png 1000 800
  wb_command -show-scene  -use-window-size ${scene_files}/Anat_QC_outputs_v2.scene 5 ${imageout}/${sub}_${sesh}_ribbon_MNINonlinear_QC.png 1000 800
  #wb_command -show-scene  -use-window-size ${scene_files}/Anat_QC_outputs_v2.scene 4 ${imageout}/${sub}_${sesh}_04.png 1000 800
  #wb_command -show-scene  -use-window-size ${scene_files}/Anat_QC_outputs_v2.scene 5 ${imageout}/${sub}_${sesh}_05.png 1000 800
...
python3 ${scripts}/create_brain_images_qc_html.py ${imageout} aseg_acpc_QC.png
python3 ${scripts}/create_brain_images_qc_html.py ${imageout} aseg_acpc_transparent_QC.png
python3 ${scripts}/create_brain_images_qc_html.py ${imageout} ribbon_MNINonlinear_QC.png
python3 ${scripts}/create_brain_images_qc_html.py ${imageout} surfaces_wBrain_QC.png
python3 ${scripts}/create_brain_images_qc_html.py ${imageout} surfaces_wHead_QC.png
